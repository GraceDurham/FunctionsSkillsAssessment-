...
def full_title(name, job_title = "Engineer"):
    ...
    # I passed in the string "Balloonicorn" for name and made an optional 
    #default parameter job title for "Engineer" if user does not pass a job title 
    # I got stuck trying to figure out how to add a space between "EngineerBalloonicorn"
    #so it would read "Engineer Balloonicorn" and not "EngineerBallonicorn"
    #so there are two tests failed here but I decided to move on to do the assessment due to time constraints. 
